...
/// a `rust_math` or `fast_math` entry point. Resolve private codegen markers before
/// SPIR-T or optimizers see the module; user-authored SPIR-V decorations are untouched.
